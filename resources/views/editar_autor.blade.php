...
<small>La ruta autores.update necesita un parametro llamado AUTORE. Se lo debes pasar.
    ...
    <input type="text" name="apellido" placeholder="Introduce tu apellido" value="">
    
    <input type="text" name="email" placeholder="Introduce tu email" value="">
    
    <input type="text" name="teléfono" placeholder="Introduce tu teléfono" value=""> 
